In this project, let's build **Nxt Trendz** app with authentication by applying the concepts we have learned till now. Access the

### Live Demo below:

<div>
    <a href="https://ecomauauone.ccbp.tech/" >React Authenticate Part One<a/>
<div/>
